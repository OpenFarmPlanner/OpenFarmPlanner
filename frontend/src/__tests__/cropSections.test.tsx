...
import { ColorSection } from '../crops/sections/ColorSection';
import { NotesSection } from '../crops/sections/NotesSection';
import { SpacingSection } from '../crops/sections/SpacingSection';
...
describe('crop form UI sections', () => {
