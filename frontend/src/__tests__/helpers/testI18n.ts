export const i18nMap: Record<string, string> = {
  ...
  'hierarchy:messages.missingDimensionsCellTooltip': 'Dieser Wert wird für die Flächenberechnung und darauf basierende Planungen benötigt.',
  'messages.unsavedMissingName': 'Zeile wurde nicht gespeichert, da der Name fehlt.',
  'dialogs.unsavedRow.title': 'Zeile nicht gespeichert',
  'dialogs.unsavedRow.message': 'Name ist ein Pflichtfeld. Ohne Namen kann diese Zeile nicht gespeichert werden.',
  'dialogs.unsavedRow.continueEditing': 'Weiter bearbeiten',
  'dialogs.unsavedRow.discard': 'Verwerfen',
  ...
  'plantingPlans:tooltips.calculatedHarvestStartDate': 'Wird automatisch aus Pflanzdatum und Wachstumszeit der Kultur berechnet.',
  'plantingPlans:tooltips.calculatedHarvestEndDate': 'Wird automatisch aus Erntebeginn und Erntezeit der Kultur berechnet.',
  'plantingPlans:tooltips.missingGrowthDuration': 'Nicht berechenbar, da für diese Kultur keine Wachstumszeit hinterlegt ist.',
  'plantingPlans:tooltips.missingHarvestDuration': 'Nicht berechenbar, da für diese Kultur keine Erntezeit hinterlegt ist.',
  'plantingPlans:tooltips.missingGrowthAndHarvestDuration': 'Nicht berechenbar, da für diese Kultur weder eine Wachstumszeit noch eine Erntezeit hinterlegt ist.',
