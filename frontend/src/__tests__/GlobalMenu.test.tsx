...
const labels: Record<string, string> = {
  ...
  'globalMenu.publicLibraryModeration': 'Kulturbibliothek moderieren',
...
const baseProps = {
  ...
  onOpenPublicLibraryModeration: vi.fn(),
...
describe('GlobalMenu (desktop)', () => {
  it('groups the moderation entry as its own bracketed section for moderators', () => {
    const anchor = document.createElement('button');
    document.body.appendChild(anchor);

    render(<GlobalMenu {...baseProps} anchorEl={anchor} canModeratePublicLibrary />);
  ...
  it('hides the moderation entry and its separators entirely for non-moderators', () => {
    ...
    render(<GlobalMenu {...baseProps} anchorEl={anchor} canModeratePublicLibrary={false} />);
