...
class TestRelinkGeneralPublicCulturesMigration:
    ...
    def setup_method(self):
        ...
        self.general_culture = culture_model.objects.create(
            name='Lettuce',
        ...
        self.variety_culture = culture_model.objects.create(
            name='Lettuce',
            name_normalized='lettuce',
            variety='Bijella',
        ...
        self.orphan_variety_culture = culture_model.objects.create(
            name='Carrot',
        ...
        self.general_entry = public_culture_model.objects.create(
            name='Lettuce',
            name_normalized='lettuce',
            variety='',
            variety_normalized='',
            status='published',
            crop_species_id=species.id,
            source_project_culture_id=self.variety_culture.id,
            source_project_id=project.id,
        )
        self.variety_entry = public_culture_model.objects.create(
            name='Lettuce',
            name_normalized='lettuce',
            variety='Bijella',
            variety_normalized='bijella',
        ...
        self.orphan_general_entry = public_culture_model.objects.create(
            name='Carrot',
            name_normalized='carrot',
            variety='',
            variety_normalized='',
            status='published',
            crop_species_id=other_species.id,
            source_project_culture_id=self.orphan_variety_culture.id,
            source_project_id=project.id,
        )
    ...
    def _public_culture_model(self):
    ...
    def test_general_entry_is_relinked_to_the_projects_general_kultur(self):
        entry = self._public_culture_model().objects.get(pk=self.general_entry.pk)

        assert entry.source_project_culture_id == self.general_culture.id

    def test_variety_entry_keeps_its_own_sorte(self):
        entry = self._public_culture_model().objects.get(pk=self.variety_entry.pk)

        assert entry.source_project_culture_id == self.variety_culture.id

    def test_general_entry_without_a_local_kultur_is_left_alone(self):
        entry = self._public_culture_model().objects.get(pk=self.orphan_general_entry.pk)

        assert entry.source_project_culture_id == self.orphan_variety_culture.id
